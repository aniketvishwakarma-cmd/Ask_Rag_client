...
function L(n2, l2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  for (f2 = T(u2, l2, m3, f2, b10), a3 = 0; a3 < b10; a3++)
    null != (p2 = u2.__k[a3]) && (h2 = -1 != p2.__i && m3[p2.__i] || d, p2.__i = a3, _2 = q(n2, p2, h2, i2, r2, o2, e3, f2, c5, s2), v2 = p2.__e, p2.ref && h2.ref != p2.ref && (h2.ref && J(h2.ref, null, p2), s2.push(p2.ref, p2.__c || v2, p2)), null == y3 && null != v2 && (y3 = v2), (g2 = !!(4 & p2.__u)) || h2.__k === p2.__k ? (f2 = j(p2, f2, n2, g2), g2 && h2.__e && (h2.__e = null)) : "function" == typeof p2.type && void 0 !== _2 ? f2 = _2 : v2 && (f2 = v2.nextSibling), p2.__u &= -7);
  return u2.__e = y3, f2;
}
function T(n2, l2, u2, t5, i2) {
  ...
  if (a3)
    for (r2 = 0; r2 < s2; r2++)
      null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t5 && (t5 = $(e3)), K2(e3, e3));
  return t5;
}
function j(n2, l2, u2, t5) {
  ...
  if ("function" == typeof n2.type) {
    for (i2 = n2.__k, r2 = 0; i2 && r2 < i2.length; r2++)
      i2[r2] && (i2[r2].__ = n2, l2 = j(i2[r2], l2, u2, t5));
    return l2;
  }
  ...
  n:
    if ("style" == l2)
      if ("string" == typeof u2)
        ...
        if (u2)
          for (l2 in u2)
            t5 && u2[l2] == t5[l2] || z(n2.style, l2, u2[l2]);
      }
    else if ("o" == l2[0] && "n" == l2[1])
      r2 = l2 != (l2 = l2.replace(a, "$1")), o2 = l2.toLowerCase(), l2 = o2 in n2 || "onFocusOut" == l2 || "onFocusIn" == l2 ? o2.slice(2) : l2.slice(2), n2.l || (n2.l = {}), n2.l[l2 + r2] = u2, u2 ? t5 ? u2[s] = t5[s] : (u2[s] = h, n2.addEventListener(l2, r2 ? v : p, r2)) : n2.removeEventListener(l2, r2 ? v : p, r2);
    else {
  ...
  n:
    if ("function" == typeof T2)
      try {
        ...
        if (h2.context = $2, h2.props = k2, h2.__P = n2, h2.__e = false, I2 = l.__r, P2 = 0, x3)
          h2.state = h2.__s, h2.__d = false, I2 && I2(u2), a3 = h2.render(h2.props, h2.state, h2.context), w.push.apply(h2.__h, h2._sb), h2._sb = [];
        else
          do {
        ...
        if (u2.__v = null, c5 || null != o2)
          ...
          u2.__e = t5.__e, u2.__k = t5.__k, n3.then || B2(u2);
        l.__e(n3, u2, t5);
      }
    else
      null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = G(t5.__e, u2, t5, i2, r2, o2, e3, c5, s2);
...
function G(u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  ...
  if ("svg" == x3 ? o2 = "http://www.w3.org/2000/svg" : "math" == x3 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e3) {
    for (a3 = 0; a3 < e3.length; a3++)
      if ((y3 = e3[a3]) && "setAttribute" in y3 == !!x3 && (x3 ? y3.localName == x3 : 3 == y3.nodeType)) {
        u2 = y3, e3[a3] = null;
        break;
      }
  }
  ...
  if (null == x3)
    m3 === k2 || c5 && u2.data == k2 || (u2.data = k2);
  else {
    if (e3 = e3 && n.call(u2.childNodes), !c5 && null != e3)
      for (m3 = {}, a3 = 0; a3 < u2.attributes.length; a3++)
        m3[(y3 = u2.attributes[a3]).name] = y3.value;
    for (a3 in m3)
      y3 = m3[a3], "dangerouslySetInnerHTML" == a3 ? p2 = y3 : "children" == a3 || a3 in k2 || "value" == a3 && "defaultValue" in k2 || "checked" == a3 && "defaultChecked" in k2 || N(u2, a3, null, y3, o2);
    for (a3 in k2)
      y3 = k2[a3], "children" == a3 ? v2 = y3 : "dangerouslySetInnerHTML" == a3 ? h2 = y3 : "value" == a3 ? w2 = y3 : "checked" == a3 ? _2 = y3 : c5 && "function" != typeof y3 || m3[a3] === y3 || N(u2, a3, y3, m3[a3], o2);
    if (h2)
      c5 || p2 && (h2.__html == p2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t5.__k = [];
    else if (p2 && (u2.innerHTML = ""), L("template" == t5.type ? u2.content : u2, g(v2) ? v2 : [v2], t5, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && $(i2, 0), c5, s2), null != e3)
      for (a3 = e3.length; a3--; )
        b(e3[a3]);
...
function K2(n2, u2, t5) {
  ...
  if (i2 = n2.__k)
    for (r2 = 0; r2 < i2.length; r2++)
      i2[r2] && K2(i2[r2], u2, t5 || "function" != typeof n2.type);
...
function formatPrefixAuto_default(x3, p2) {
  ...
  if (!d2)
    return prefixExponent = void 0, x3.toPrecision(p2);
